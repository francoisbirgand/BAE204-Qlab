...
cumQ=c(0,(cumsum(Q[-1])+cumsum(head(Q,-1)))/2)*600/WSarea/100 # calculates in mm the cumulative flow for each time stamp 
...
data<-as.data.frame(data)
data$datetime<-as.POSIXct(strptime(data$datetime, "%Y-%m-%d %H:%M:%S")) # transforms characters into date values understood by R
startdate<-as.POSIXct("1998-07-04 12:00:00")
enddate<-as.POSIXct("1998-07-08 12:00:00")

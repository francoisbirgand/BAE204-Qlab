...
- To introduce you to the variability of flow and concentrations in nature
- To the concepts of flux calculations
- To introduce you to the power of R and RStudio
...
library(shape)
par(mar=c(4.5,4.5,0.5,0.5))
transpred <- rgb(250, 0, 0, max = 255, alpha = 25)
transpblue <- rgb(0, 0, 250, max = 255, alpha = 25)
xlimHG=as.POSIXct(c("1999-01-03 00:00:00","1999-01-08 00:00:00"));ylimHG=c(50,350)
plot(date,Q,xlab = "date",ylab = "Flow rate (L/s)",type = "l",col="blue",xlim=xlimHG,ylim=ylimHG)
rect(as.numeric(as.POSIXct("1999-01-03 7:30:00")),0,as.numeric(as.POSIXct("1999-01-03 17:03:00")),400,col = transpred)
rect(as.numeric(as.POSIXct("1999-01-03 17:03:00")),0,as.numeric(as.POSIXct("1999-01-08 00:00:00")),400,col = transpblue)
par(new=TRUE)
plot(date,Q,xlab = "date",ylab = "Flow rate (L/s)",type = "l",col="blue",xlim=xlimHG,ylim=ylimHG)
text((as.numeric(as.POSIXct("1999-01-03 7:30:00"))+as.numeric(as.POSIXct("1999-01-03 17:03:00")))/2,200,"Rising limb", col = "red",srt = 90)
text((as.numeric(as.POSIXct("1999-01-03 17:03:00"))+as.numeric(as.POSIXct("1999-01-08 00:00:00")))/2,200,"Falling limb", col = "blue")
abline(v=as.numeric(as.POSIXct("1999-01-03 7:30:00")), lty=2)
abline(v=as.numeric(as.POSIXct("1999-01-03 17:03:00")), lty=2)
Arrows(as.numeric(as.POSIXct("1999-01-03 7:30:00")),100, as.numeric(as.POSIXct("1999-01-03 17:03:00")),100, arr.adj = 1, code=3)
text((as.numeric(as.POSIXct("1999-01-03 7:30:00"))+as.numeric(as.POSIXct("1999-01-03 17:03:00")))/2,120,"Time of rise")
...
For this, there is the `quantile` function. Search `?quantile` in the console and calculate these values and report them in the text as a list.
...
cumQQ=c(0,(cumsum(QQ[-1])+cumsum(head(QQ,-1)))/2)*600/WSarea/100
print(max(cumQ))
